...
class _CreateBlogState extends State<CreateBlog> {
  String authorName, title, desc,content;
            ...
            Container(
              ...
              child: Column(
                children: <Widget>[
                  ...
                  TextField(
                    maxLength: 50,
                    decoration: InputDecoration(hintText: "Write your Subject here"),
                    onChanged: (val) {
                      desc = val;
                    },
                  ),
                  TextField(
                    ...
                    maxLines: null,
                    decoration: InputDecoration(hintText: "Write Blog Content Here"),
                    onChanged: (val) {
                      content = val;
                    },
                  ),
